class Surtidor:
    def __init__(self,num_surtidor,tipo_com,stock,precio_litro,estado):
        self.__num_surtidor=num_surtidor
        self.__estado='deshabilitado'
        self.__playero=''
        self.__tipo_com=tipo_com
        self.__stock=stock
        self.__precio_litro=precio_litro
        self.__cant_de_litros=0
        self.__monto_ven=0
        self.__total_litros_vend=0
    ...
    def ver_total_litros_vend(self):
        return self.__total_litros_vend
    ...
    def mod_total_litros_vend(self,otro):
        self.__total_litros_vend=otro
